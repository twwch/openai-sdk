...
public class AzureOpenAIExample {
    public static void main(String[] args) {
        ...
        try {
            ...
            String response = openai.chat(modelV, "你好，请介绍一下自己。");
            System.out.println("AI回复: " + response);
            System.out.println();
            
            // 示例3：使用系统提示和用户提示
            System.out.println("带系统提示的聊天示例：");
            response = openai.chat(modelV, "你是一个专业的Java开发者", "请解释Java中的多态性。");
            System.out.println("AI回复: " + response);
            System.out.println();
            ...
            ChatCompletionResponse chatResponse = openai.createChatCompletion(modelV, messages);
